...
//-------------------------------------------------------------------
static 
    if (false) console.log("a static initializer, just for the halibut")

//-------------------------------------------------------------------
method addTestSuite(testSuiteClass)
...
//-------------------------------------------------------------------
method _runSuite(suiteClass, results)
...
//-------------------------------------------------------------------
method _newSuite(suiteClass, results)
    try {
...
//-------------------------------------------------------------------
method _runCatching(suite, methodName, results)
    var func
...
//-------------------------------------------------------------------
method _runTest(suite, testName, results)
...
//-------------------------------------------------------------------
static method resultsAsHTML(results)
...
//-------------------------------------------------------------------
static method resultsToConsole(results)
